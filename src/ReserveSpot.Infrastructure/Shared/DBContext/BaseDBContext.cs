...
using ReserveSpot.Infrastructure.Shared.Events;

namespace ReserveSpot.Infrastructure.Shared.DBContext;
public abstract class BaseDbContext<TContext> : DbContext where TContext : DbContext
{
    ...
    public override async Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
    {
       ...
       // Data.SaveChanges();
        //await this.SaveChangesAsync(cancellationToken: cancellationToken);
